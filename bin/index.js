...
program
  ...
  .action(function () {
    ...
    console.log(chalk.green("\ngtg display:\n"));
    console.log(
      `Use this to view the suggested branch name and commit title. You can also edit the suggested text based on your preference. This command should be run after ${chalk.yellow("gg start")}.\n`
    );
    console.log(chalk.green("\ngtg checkout:\n"));
    console.log(
      `This is a replacement for ${chalk.yellow("git checkout -b")} and will simply checkout with gitgo's suggested branch name.\n`
    );
    console.log(chalk.green("\ngtg checkout:\n"));
    console.log(
      `This is a replacement for ${chalk.yellow("git checkout -m")} and will commit your files once added with gitgo's suggested commit message.\n`
    );
  });
