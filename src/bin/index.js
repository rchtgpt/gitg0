...
var _a = require("../lib/inquirer.js"), getQuestions = _a.getQuestions, getConfigQuestions = _a.getConfigQuestions, displaySuggestions = _a.displaySuggestions;
var simpleGit = require("simple-git");
var git = simpleGit();
var jsonReader = require("../lib/funcs/jsonReader.js").jsonReader;
    ...
    if (files.directoryExists(".git")) {
        ...
        fs.stat("./.gitgo", function (err, stat) {
            if (err == null) {
                ...
                fs.writeFile("./.gitgo", JSON.stringify(conf, null, 2), function (err) {
                    if (err)
...
program
    ...
    if (files.directoryExists(".git")) {
        ...
        jsonReader("./.gitgo", function (err, conf) {
            if (err) {
    ...
    if (files.directoryExists(".git")) {
        ...
        jsonReader("./.gitgo", function (err, conf) {
            ...
            if (conf.commit_config) {
                ...
                setTimeout(function () {
                    exec("git add ./.gitgo", function (error, stdout, stderr) {
                        if (error) {
                ...
                exec("git reset -- ./.gitgo", function (error, stdout, stderr) {
                    if (error) {
                        console.log("error: " + error.message);
                        return;
                    }
...
program
    ...
    console.log("You just need to know 7 simple commands you and then you're " + chalk.bold.cyan("gtg") + " : " + chalk.magenta("Good to Go"));
