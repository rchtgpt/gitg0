        ...
        for (repo in response.data) {
          if (
            ...
            axios.get(finalBranchLink).then(function (branchNamesRes) {
              ...
              .catch((err) => {
                console.log(chalk.bold.red("0opsie wo0psie couldn't fetch your branch names. Have you entered the correct Github Issue number?", emoji.get(":cry:")));
                exit();
              });
            ...
            axios.get(finalIssueLink)
              .then(function (res) {
                ...
                if (titleOfIssue !== '') {
                  ...
                  console.log(chalk.red("We are facing some issues in the backend. Please try again later.", emoji.get(":cry:")));
                  exit();
                }
              })
              .catch((err) => {
                console.log(chalk.bold.red("0opsie wo0psie couldn't fetch your issue title. Have you entered the correct Github Issue number?", emoji.get(":cry:")));
                exit();
              });
          }
        }
