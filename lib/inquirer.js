            ...
            .then((ans1) => {
              ...
              inquirer
                ...
                .then((ans2) => {
                  ...
                  } else if (ans2["emojis"] === "n" || ans2["emojis"] === "N" || ans2["emojis"] === '') {
                    emo = false;
                  } else {
                    console.log(`We don't know what you mean by "${ans2["emojis"]}" ${emoji.get(":cry:")}`);
                    exit();
                  }
                  reader.jsonReader("./.gitgo", (err, conf) => {
                    if (err) {
                  ...
                  console.log(
                    `\nSettings for your repo have been stored. Run ${chalk.yellow('gg start')} before working on an issue to get the branch name and commit title automatically. If you would like to change any settings manually, please edit the .gitgo file.\n`
                  );
                });
            });
        } else {
