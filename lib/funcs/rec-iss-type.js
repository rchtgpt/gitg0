    ...
    reader.jsonReader("./.gitgo", (err, conf) => {
      ...
      for (let i = 0; i < issue_labels.length; i++) {
        if (issue_labels[i] === "enhancement") {
          ...
          issue_labels[i] !== "bug" &&
          issue_labels[i] !== "enhancement" &&
          issue_labels[i] !== "help wanted" &&
          issue_labels[i] !== "question" &&
          issue_labels[i] !== "invalid" &&
          issue_labels[i] !== "duplicate" &&
          issue_labels[i] !== "good first issue" &&
          issue_labels[i] !== "documentation" &&
          issue_labels[i] !== "wontfix"
        ) {
          inquirer
            .prompt([{
              // displays emoji based MCQ
